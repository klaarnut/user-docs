...
1. *Active*, Check this box for immediately activate this user once added.
1. *Verified*, Check this box to make this user verified by you once added.
1. *Send user welcome email*, Check this box to send Account Activation email to this user by email address given above.
1. *Sene new registered user email to add administrator*, Check this box to send New Activated User to all administrator of this website.
